import { History, ArrowLeft, Mail } from "lucide-react"
  ...
  return (
    <>
      ...
      <div className="mb-6">
        ...
        <p className="text-muted-foreground mt-1">View and manage your sent newsletters</p>
      </div>
      ...
      <div className="flex items-center justify-center py-16">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center max-w-md">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Newsletter History - Coming Soon</h2>
          <p className="text-gray-600 mb-6">
            We're building a comprehensive history of all your sent newsletters with analytics and insights.
          </p>
